...
var Editor = function (_a) {
    ...
    return ((0, jsx_runtime_1.jsxs)("div", __assign({ className: "h5p-editor", style: { height: height, position: "relative" } }, { children: [editorState.state === "loading" && (0, jsx_runtime_1.jsx)(loader_1.default, {}), editorState.state === "error" && ((0, jsx_runtime_1.jsxs)("p", { children: [(0, jsx_runtime_1.jsx)("pre", { children: "Error:" }), " ", editorState.error] })), src && ((0, jsx_runtime_1.jsx)("iframe", { ref: iFrameRef, title: "editor", src: src, style: {
                    width: "100%",
                    height: "100%",
                    margin: 0,
                    padding: 0,
