...
var Player = function (_a) {
  var h5pObject = _a.h5pObject,
    id = _a.id,
    onXAPI = _a.onXAPI,
    _b = _a.styles,
    styles = _b === void 0 ? [] : _b;
  var _c = (0, react_1.useState)(100),
    height = _c[0],
    setHeight = _c[1];
  ...
  var _d = (0, react_1.useState)(true),
    loading = _d[0],
    setLoading = _d[1];
  var _e = (0, react_1.useContext)(context_1.EditorContext),
    state = _e.state,
    seth5pObject = _e.seth5pObject;
  (0, react_1.useEffect)(
    function () {
  ...
  var changeHeight = (0, react_1.useCallback)(
  ...
  var onMessage = (0, react_1.useCallback)(
    function (event) {
    ...
    function () {
      ...
      var embedType =
        content === null || content === void 0
          ? void 0
          : content.content.library.embedTypes;
          ...
          children: [
            (0, jsx_runtime_1.jsxs)("head", {
              children: [
                ...
                __spreadArray(
                  __spreadArray([], settings.core.scripts, true),
                  settings.loadedJs,
                  true
                ).map(function (script) {
                  return (0,
                ...
                __spreadArray(
                  __spreadArray([], settings.core.styles, true),
                  settings.loadedCss,
                  true
                ).map(function (style) {
                  return (0,
            ...
            (0, jsx_runtime_1.jsx)("body", {
              children: (0, jsx_runtime_1.jsxs)(
                "div",
                __assign(
                  { className: "h5p-player-wrapper h5p-resize-observer" },
                  {
                    children: [
                      ...
                      (0, jsx_runtime_1.jsx)("script", {
                        children:
                          '\n            (function ($) {\n                const replacerFunc = () => {\n                    const visited = new WeakSet();\n                    return (key, value) => {\n                      if (value.nodeType) return;\n                      if (typeof value === "object" && value !== null) {\n                        if (visited.has(value)) {\n                          return;\n                        }\n                        visited.add(value);\n                      }\n                      return value;\n                    };\n                  };\n                const postMessage = (data) => parent.postMessage(data, "'.concat(
      ...
      return window.URL.createObjectURL(
        new Blob(
          [(0, html_escaper_1.unescape)(markup).split("&#x27;").join("'")],
          {
            type: "text/html",
          }
        )
